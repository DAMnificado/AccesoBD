...
public class FromTabla extends JFrame {
	...
	public FromTabla() {
		...
		JComboBox comboBoxTabla = new JComboBox();
...
//				String pass=new String(password);
				...
				Conec miConexion=new Conec(host,puerto,user,pass);
